...
func (a *arangoDB) processInetV4Prefix(ctx context.Context, key string, e *message.UnicastPrefix) error {
...
func (a *arangoDB) processeBgpV4Prefix(ctx context.Context, key string, e *bgpPrefix) error {
...
func (a *arangoDB) processUnicastPrefixV4Removal(ctx context.Context, key string) error {
